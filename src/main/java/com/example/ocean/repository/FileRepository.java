...
public interface FileRepository {
    ...
    int insertFile(CreateEventRequest.FileEntity fileEntity);
    List<CreateEventRequest.FileEntity> selectFileByEventCd(@Param("eventCd")String eventCd);
    CreateEventRequest.FileEntity selectFileByFileId(@Param("fileId")String fileId);
